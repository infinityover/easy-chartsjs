...
@Component({
  selector: 'ng-water-gauge-chart',
  templateUrl: './water-gauge-chart.component.html',
  styleUrls: ['./water-gauge-chart.component.css']
})
export class WaterGaugeChartComponent implements OnInit {

  @ViewChild('gauge',null) gauge: any;
  ...
  @Input() private size = this.defaultSettings.size;
